...
const PoultryDrawer = () => {
  ...
  const categories = [
    ...
    { id: 'minerals-vitamins', name: 'Minerals & Vitamins' },
    { id: 'anti-stress', name: 'Anti-stress' },
    { id: 'hepatorenal-tonics', name: 'HepatoRenal tonics' },
    { id: 'anti-mycotoxin', name: 'Anti-mycotoxin' },
    { id: 'growth-promotors', name: 'Growth promotors' },
    { id: 'immunostimulants', name: 'Immunostimulants' },
    { id: 'mucolytics-expectorants', name: 'Mucolytics & Expectorants' },
    { id: 'anti-clostridial', name: 'Anti-clostridial drugs' }
  ];
