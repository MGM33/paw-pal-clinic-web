...
interface CatMedicineDrawerProps {
  currentCategory: 'medicines' | 'vaccines' | 'cosmetics-supplements';
}

const CatMedicineDrawer = ({ currentCategory }: CatMedicineDrawerProps) => {
  const categories = [
    { id: 'medicines', name: 'Medicines', path: '/cats/medicines' },
    { id: 'vaccines', name: 'Vaccines', path: '/cats/vaccines' },
    { id: 'cosmetics-supplements', name: 'Cosmetics & Supplements', path: '/cats/cosmetics-supplements' }
  ];
    ...
    <Drawer>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>
            Select a category to view specialized products for cats
          </DrawerDescription>
        </DrawerHeader>
