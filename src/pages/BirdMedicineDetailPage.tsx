...
const BirdMedicineDetailPage = () => {
  const { medicineId } = useParams<{ medicineId: string }>();
  
  React.useEffect(() => {
    document.title = `VetCare | Poultry Bird Medicine ${medicineId} Details`;
  }, [medicineId]);
  
  // Bird-specific medicine data
  const medicineData = {
    name: `Poultry Bird Medicine ${medicineId}`,
    description: `This is a specialized medicine for poultry birds. Medicine ${medicineId} is formulated specifically for avian health needs and provides targeted treatment for various poultry-specific conditions.`,
    ...
    ingredients: 'Active ingredients optimized for avian metabolism. Contains bird-safe compounds that are specifically tested for poultry use and respiratory health.',
    ...
    sideEffects: 'Potential side effects in poultry may include temporary decreased egg production, mild respiratory changes, or temporary digestive upset. Contact your veterinarian if severe reactions occur.',
    image: `https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=600&h=400&fit=crop&sig=bird-${medicineId}`,
  };
          ...
          <div className="glass-effect rounded-lg overflow-hidden">
            <div className="md:flex">
              ...
              <div className="md:w-1/2 p-8">
                ...
                >
                  Back to Poultry Bird Medicines
                </Link>
              </div>
            </div>
          </div>
...
export default BirdMedicineDetailPage;
